        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Edit Property</h1> 
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            <form action="postProperty" method="post" enctype="multipart/form-data">
                                <div class="row g-3">
                                        ...
                                        <div class="form-floating">
                                            <input type="hidden" name="prop_id" class="form-control" id="name" value="${PP.prop_id}">
                                            <label for="name"></label>
                                        </div>
                                    
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" name="prop_name" class="form-control" id="name" value="${PP.prop_name}" >
                                            <label for="">Update Property Name</label>
                                        </div>
                                    </div>
                                   <div class="col-md-4">
                                <select class="form-select  py-3"  name="prop_type">
                            ...
                            <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" name="prop_price" class="form-control" value="${PP.prop_price}" id="name" >
                                            <label for="name">Change Property Price</label>
                                        </div>
                                    </div>
                            
                            <div class="col-md-4">
                                <select class="form-select  py-3"  name="prop_status">
                            ...
                            <div class="col-md-4">
                                <select class="form-select  py-3" name="prop_subtype">
                                    <option selected>Property Subtype</option>
                                    <option value="1 RK">1 RK</option>
                                    <option value="2 RK">2 RK</option>
                                    <option value="3 RK">3 RK</option>
                                     <option value="4 RK">4 RK</option>
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" name="prop_location" class="form-control" value="${PP.prop_location}" id="name" placeholder="Your Name">
                                            <label for="name">Location</label>
                                        </div>
                                    </div>
                             <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" name="prop_pincode" class="form-control" value="${PP.prop_pincode}" id="name" placeholder="Your Name">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" name="prop_area" class="form-control" value="${PP.prop_area}" id="name" placeholder="Your Name">
                            ...
                            <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="file" name="filename" class="form-control" id="name" placeholder="Your Name">
