        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
             <center>   <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">My Appointments</h1> 
            </div>
            </center>
        </div>
        <!-- Header End -->
<center>
  ...
  <c:forEach var="e" items="${pa}">  
                   <tbody>
                   <tr>
                    <td>${e.appoint_name}</td>
                     <td>${e.appoint_phone}</td>
                     <td>${e.email}</td>
                     <td>${e.appoint_subject}</td>
                     <td> ${e.appoint_msg}</td>
					<td>
					<a style="color:red;" href="delete_appointment?id=${e.appoint_id}" >DELETE</a>
					</td>
                   </tr>
				</tbody>
                 </c:forEach> 
