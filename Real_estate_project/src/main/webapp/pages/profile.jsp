		...
		<div class=" image d-flex flex-column justify-content-center align-items-center"> 
			...
			HttpSession sp2 = request.getSession();
				...
				<div class="d-flex flex-row justify-content-center align-items-center gap-2"> 
					<span class="idd1">
					<%
                            String pass = (String) s1.getAttribute("p");
			HttpSession sp3 = request.getSession();
				sp2.setAttribute("abc3",pass);
                            %>
                            <%
                            String cpass = (String) s1.getAttribute("cp");
			HttpSession sp4 = request.getSession();
				sp2.setAttribute("abc4",cpass);
                            %>
					</span>
				</div> 
				<div class="d-flex flex-row justify-content-center align-items-center mt-3"> 
					<span class="number">1069 <span class="follow">View Properties</span></span> 
				</div> 
				<br>
			</div>
			<div class=" d-flex mt-2"> 
					<a href="buyerDashboard" class="btn btn-danger ">Back to home</a>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
