 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li class="active"><a href="adminLogout"><i class="zmdi zmdi-square-right text-danger"></i> <span>Logout</span></a></li>
	...
	<div class="card card-authentication1 mx-auto my-5">
		<div class="card-body">
		 <div class="card-content p-2">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Admin Logout, Are You Sure? </div>
		   
			</div>
			<div class="col-md-12">
			
			 <a href="/" class="btn btn-light btn-block">Logout</a>
			 <a href="adminLogout" class="btn btn-light btn-block">Cancel</a>
			 </div>
