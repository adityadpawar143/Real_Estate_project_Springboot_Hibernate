            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="buyerAbout" class="nav-item nav-link active">About</a>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="about-img position-relative overflow-hidden p-5 pe-0">
                            <img class="img-fluid w-100" src="Buyer/img/abt.jpg">
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">Welcome to Imperial Realty</h1>
                        <p class="mb-4">- The Real Estate Business</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Welcome to Imperial Realty, Pune a luxury urban residence designed for maximum value for price and space.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Imperial Realty, Pune 
						from the house of Real Estate, presenting in Pune for sale.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>At Imperial Realty, Pune life extends beyond the expectation to embrace your life.
						Built with meticulousness and inimitable features, Imperial Realty, Pune is just for the chosen few.</p>
						     <p><i class="fa fa-check text-primary me-3"></i>This project is close to some of Pune's biggest Industrial landmarks, like SP Infocity, Magarpatta IT Park, and EON IT Park.
						Discover a quality of life at Imperial Realty, Pune that is truly unique.</p>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="Buyer/img/pic.jpeg" alt="">
                            ...
                            <div class="text-center p-4 mt-3">
                                <h5 class="fw-bold mb-0">Aditya Pawar</h5>
                                <small></small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="Buyer/img/bhag.jpg" alt="">
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-instagram"></i></a>
                            ...
                            <div class="text-center p-4 mt-3">
                                <h6 class="fw-bold mb-0">Bhagyashri Takale</h6>
                                <small></small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="Buyer/img/gun.jpg" alt="">
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-instagram"></i></a>
                            ...
                            <div class="text-center p-4 mt-3">
                                <h5 class="fw-bold mb-0">Gunjan Patil</h5>
                                <small></small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="Buyer/img/kom.jpg" alt="">
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-instagram"></i></a>
                            ...
                            <div class="text-center p-4 mt-3">
                                <h6 class="fw-bold mb-0">Komal Deshmukh</h6>
                                <small></small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="Buyer/img/vidya.jpg" alt="">
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-instagram"></i></a>
                            ...
                            <div class="text-center p-4 mt-3">
                                <h5 class="fw-bold mb-0">Vidya Nikam</h5>
                                <small></small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="Buyer/img/kajal.jpg" alt="">
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square mx-1" href=""><i class="fab fa-instagram"></i></a>
                            ...
                            <div class="text-center p-4 mt-3">
                                <h5 class="fw-bold mb-0">Kajal Nikam</h5>
                                <small></small>
                            </div>
                        </div>
                    </div>
