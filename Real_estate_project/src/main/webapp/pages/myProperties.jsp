...
<br><br><br>
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
             <center>   <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">My Properties</h1> 
            </div>
  ...
  <c:forEach var="e" items="${l8}">  
                   <tbody>
                   <tr>
                    <td>${e.prop_name}</td>
                     <td><a href=""><img class="img-fluid" src="BuyerImg/${e.prop_photo}" alt="" width="40"></a></td>
					<td>${e.prop_type}</td>
					<td>${e.prop_price}</td>
					<td>${e.prop_status}</td>
					<td>${e.prop_subtype}</td>
					<td>${e.prop_bedrooms}</td>
					<td>${e.prop_bathrooms}</td>
					<td>${e.prop_location}</td>
					<td>${e.prop_area}  ${e.prop_measurement}</td>
					<td>
					<a style="color:green;" href="edit_property?id=${e.prop_id}" >EDIT</a> |
					<a style="color:red;" href="delete_property?id=${e.prop_id}" >DELETE</a>
					</td>
                   </tr>
				</tbody>
                 </c:forEach> 
